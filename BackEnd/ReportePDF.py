...
class reportePDF(object):
    ...
    def _encabezadoPiePagina(canvas, archivoPDF):
        ...
        # Encabezado
        encabezadoNombre = Paragraph("ESPE", estilos["Normal"])
        ...
        # Pie de página
        piePagina = Paragraph("Reporte generado por tu papa.", estilos["Normal"])
    ...
    def Exportar(self):
        ...
        archivoPDF = SimpleDocTemplate(self.nombrePDF, leftMargin=50, rightMargin=50, pagesize=letter,
                                       title="Reporte PDF", author="Tu ñaña")
        ...
        try:
         ...
         # +------------------------------------+
            return messagebox.showinfo(message="Reporte generado con éxito")
         # +------------------------------------+
